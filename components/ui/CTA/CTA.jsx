                    ...
                    <div className="relative z-10">
                        <div className="max-w-xl mx-auto text-center">
                            <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                                Unleash the Power of AI with HolyGyaan
                            </h2>
                            <p className="mt-5 text-gray-300">
                                HolyGyaan is the perfect answer! Our AI-based platform enables you to ask your queries directly from the religious holy books.
                            </p>
                        </div>
