...
const Features = () => {
    ...
    const featuresList = [
        ...
        },
        {
            ...
            desc: "HolyGyaan uses AI to create personalized emails for each recipient based on their past interactions with the brand."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                >
                    <div className="max-w-xl mx-auto text-center">
                        <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                            Start growing your email marketing with HolyGyaan
                        </h2>
                        <p className="mt-3">
